...
<div class="container mx-auto p-6">
    ...
    <div class="bg-white shadow-lg rounded-xl p-6 mb-6">
        ...
        <form action="{{ route('schedules.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            {{-- Nama Acara --}}
            <div>
                <label class="block text-gray-700 font-medium mb-2">Nama Acara <span
                        class="text-red-500">*</span></label>
            ...
            <div>
                ...
                <div id="file-name" class="mt-2 text-sm text-gray-600 hidden">
                    ...
                    <button type="button" onclick="clearFile()" class="text-red-500 ml-2 hover:underline">Hapus</button>
                </div>
            </div>
            ...
            <table class="min-w-full border border-gray-200">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="px-4 py-3 border text-left text-sm font-semibold text-gray-700">Surat</th>
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <form id="editForm" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" id="editName" class="w-full border border-gray-300 rounded-lg p-2.5"
                    required>
            </div>
            ...
            <div id="currentFileDiv" class="hidden">
                ...
                <div class="flex items-center space-x-2 bg-gray-50 p-3 rounded-lg">
                    ...
                    <a id="currentFileLink" href="#" target="_blank" class="text-blue-600 hover:underline">Lihat
                        file</a>
                </div>
            </div>

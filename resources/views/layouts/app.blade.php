...
<body class="bg-gradient-to-br from-emerald-50 via-teal-50 to-green-50 font-sans antialiased"
    ...
    <div class="min-h-screen flex">
        ...
        <aside :class="sidebarOpen ? 'w-72' : 'w-20'"
            ...
            <div class="flex items-center gap-3 mb-12 pb-6 border-b border-emerald-400/30">
                ...
                <div x-show="sidebarOpen" x-transition class="flex flex-col">
                    <img src="{{ asset('images/diskom.png') }}" alt="Kominfo" class="w-30">
                </div>
            </div>
        ...
        <div class="flex-1 flex flex-col">
            ...
            <!-- Modern Navbar -->
            <header
                class="glass-effect shadow-sm px-8 py-4 flex items-center justify-between border-b border-emerald-100 animate-fade-in">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" :class="open ? 'rotate-180' : 'rotate-0'"
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            class="absolute right-0 mt-3 w-52 bg-white border border-gray-200 rounded-xl shadow-xl z-9999 overflow-hidden">

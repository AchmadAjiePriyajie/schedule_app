        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventDidMount: function (info) {
                    ...
                    const colorMap = {
                        0: { bg: '#fbbf24', text: '#78350f' }, // Pending (amber)
                        1: { bg: '#10b981', text: '#ffffff' }, // Accepted (emerald)
                        2: { bg: '#3b82f6', text: '#ffffff' }, // On Going (blue)
                        3: { bg: '#9ca3af', text: '#ffffff' }, // Finished (gray)
                        4: { bg: '#ef4444', text: '#ffffff' }  // Cancelled (red)
                    };

                    const colors = colorMap[status] || { bg: '#e5e7eb', text: '#374151' };

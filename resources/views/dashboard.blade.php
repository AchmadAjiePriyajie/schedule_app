...
<div id="eventModal" class="fixed inset-0 bg-black/50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
        ...
        <div class="mt-4 text-right">
            <button onclick="closeModal()" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded">
                Tutup
            </button>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            let calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                height: 'auto',
                locale: 'id',
                displayEventEnd: true, // tampilkan waktu akhir juga
                eventDisplay: 'block', // pastikan event tampil per hari
                expandRows: true, // biar event tidak numpuk
                headerToolbar: {
